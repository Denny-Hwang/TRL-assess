...
中リスクと高リスクの件数を基に、p. 13 の参照表から ARL を読み取ります：1〜3 は **Low Readiness**、4〜6 は **Medium Readiness**、7〜9 は **High Readiness**。出典はこの数値を任意のものとしているため、結果ページではまずリスクプロファイルを示します。表は変更せずに使用しています。
...
ARL のワークブックについては、[Excel 出力](/guide/excel#導入準備度のワークブック)で説明しています。
