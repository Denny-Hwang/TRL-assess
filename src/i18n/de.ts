...
export const de: Messages = {
  ...
  'disclaimer.trl': '{app} erstellt ausschließlich eine Selbstbewertung. Sie ist keine unabhängige Technologiereifebewertung (TRA), kein Audit und keine Zertifizierung. Die Ergebnisse hängen vollständig von den Angaben ab, die der Nutzer eingibt; das Tool überprüft nichts. Bewertungskriterien unterscheiden sich zwischen Behörden und Programmen — prüfen Sie die Kriterien und Quellen, bevor Sie ein Ergebnis in einer formellen Einreichung verwenden.',
  'disclaimer.arl': '{app} erstellt ausschließlich eine Selbstbewertung. Die ARL-Werte wenden das Bewertungsraster des DOE Adoption Readiness Assessment auf die von Ihnen eingegebenen Einstufungen an: Das Tool überprüft nichts, und das DOE prüft oder bestätigt das Ergebnis nicht. Die Quelle bezeichnet den numerischen Wert als optional und warnt vor Scheingenauigkeit — das Risikoprofil, nicht die Zahl, zeigt, wo die Hindernisse liegen. ARL ergänzt TRL; dieses Tool fasst beide niemals zu einem Wert zusammen.',
  ...
  'tier2.delta.lower': 'Die nachweisbasierte Bewertung liegt deutlich unter der Schnelleinschätzung. Das ist die übliche Richtung: Tier 2 verlangt für jede Aussage einen Nachweis, zählt eine Stufe nur, wenn alle niedrigeren Stufen erreicht sind, und nimmt das Minimum über die kritischen CTEs. Prüfen Sie, welches CTE begrenzend ist und welchen Kriterien noch Nachweise fehlen.',
  ...
  'home.lead': 'Wie weit wurde diese Technologie demonstriert — und können Sie es belegen?',
  ...
  'home.ladder.caption': 'Eine Stufe zählt nur, wenn jede Stufe darunter zählt. Dieses Tool zeigt, wo die Kette abbricht — und was nötig wäre, um eine Sprosse höher zu kommen.',
  ...
  'home.tier1.body': 'Beantworten Sie neun Fragen und erhalten Sie einen TRL samt nachvollziehbarer Begründung.',
  'home.tier1.start': 'Schnelleinschätzung starten',
  'home.tier2.heading': 'Tier 2 — Nachweisbasierte Bewertung',
  'home.tier2.body': 'Kriterien je Element, jeweils belegt durch ein Dokument, einen Prüfbericht oder einen festgelegten Commit.',
  'home.tier2.start': 'Nachweisbewertung starten',
  'home.arl.heading': 'Zusatzmodul — Einführungsreifegrad (ARL)',
  'home.arl.body': 'Was zwischen einer funktionierenden Technologie und ihrem Einsatz steht: Bewerten Sie die 17 Einführungsrisiko-Dimensionen des DOE Adoption Readiness Assessment für heute und für das Projektende, und lesen Sie ARL Beginn und ARL Ende aus der Nachschlagetabelle der Quelle ab. Getrennt vom TRL-Ergebnis geführt — niemals zu einer Zahl zusammengefasst.',
  'home.arl.start': 'Einführungsreife bewerten',
  'home.disclaimer.heading': 'Haftungsausschluss',
  'about.title': 'Über {app}',
  'about.lead': 'Ein zweistufiges Tool zur Selbstbewertung des Technologiereifegrads (TRL). Tier 1 liefert eine schnelle Schätzung auf Basis der Selbstauskunft; Tier 2 erstellt eine nachweisgestützte Bewertung der kritischen Technologieelemente, die nach Excel exportiert und zusammen mit den Nachweisdateien und einem SHA-256-Manifest gepackt werden kann. Alles läuft in Ihrem Browser — es gibt kein Backend, kein Konto und keine Telemetrie.',
  ...
  'about.disclaimer.unverified': 'Nichts, was Sie eingeben, wird vom Tool überprüft.',
  ...
  'tier1.context.lead': 'Ein paar Zeilen dazu, was bewertet wird. Nichts davon verlässt Ihren Browser.',
  ...
  'tier1.context.testWhenHint': 'Zum Beispiel 2026-04.',
  ...
  'tier1.context.crossCheckNote': 'Diese beiden Antworten steuern eine heuristische Gegenprüfung ({status}). Sie setzt Ihre Antworten nie außer Kraft — sie weist nur auf Unstimmigkeiten hin.',
  ...
  'tier1.q.progress.before': '{answered} / {total} beantwortet · die ununterbrochene Folge von ',
  'tier1.q.progress.after': ' ab TRL 1 ergibt Ihre Schätzung',
  ...
  'tier1.q.guide.before': 'Unsicher, was eine Stufe bedeutet? Siehe ',
  'tier1.q.guide.link': 'Leitfaden',
  'tier1.q.guide.after': '.',
  ...
  'tier2.page.lead': 'Zerlegen Sie das System in kritische Technologieelemente, bewerten Sie die Kriterien auf jeder TRL-Stufe und verknüpfen Sie die Nachweise hinter jeder Aussage.',
  ...
  'tier2.evidencePage.lead': 'Alles, was Sie als Beleg erfasst haben, und wofür jeder Eintrag verwendet wird.',
  ...
  'tier2.result.stat.limitingHint': 'Die kritischen CTEs, die die Systemzusammenfassung nach unten begrenzen.',
  ...
  'tier2.cte.empty': 'Benennen Sie zuerst die Teile des Systems, deren Reife tatsächlich darüber entscheidet, ob es funktioniert.',
  ...
  'evidence.form.urlHint': 'Nur http oder https. Verwenden Sie dies für alles, was bereits an einem erreichbaren Ort liegt.',
  ...
  'evidence.form.fileHint': 'Nur in diesem Browser gespeichert (IndexedDB). Maximal {limit} MB. Beim Hinzufügen wird ein SHA-256-Hash berechnet.',
  ...
  'evidence.library.empty': 'Noch keine Nachweise. Nachweise machen aus einer Behauptung eine Bewertung: ein Bericht, ein Prüfprotokoll, ein festgelegter Commit, eine DOI oder ein Verweis auf ein kontrolliertes Dokument.',
  ...
  'arl.unavailable.body': 'Diese Sitzung wurde anhand des ARL-Bewertungsrasters „{id}“ eingestuft, das in dieser Version der App nicht enthalten ist ({detail}). Setzen Sie die ARL-Einstufungen zurück, um mit dem aktuellen Bewertungsraster neu zu beginnen.',
  'arl.scope.title': 'Einführungsreife — Schritt 1 von 3: Umfang',
  'arl.scope.lead': 'Was bewertet wird und für welchen Markt. Nichts davon verlässt Ihren Browser.',
  ...
  'arl.rate.conservative': 'Alles, was nicht eingestuft, „Unsicher“ oder „N/A“ ohne Begründung ist, zählt als hohes Risiko, bis es geklärt ist. Ziele beschreiben das Projektende: Ziel — geplant, nicht erreicht.',
  ...
  'arl.result.changeHint': 'ARL Ende minus ARL Beginn.',
  'arl.result.scopeMissing.before': 'Der Technologieumfang oder der Zeithorizont der Bewertung ist leer. Die Quelle verlangt, beides vor der Einstufung festzulegen — dieselbe Technologie kann bei einem anderen Umfang anders eingestuft werden.',
  ...
  'arl.result.howRead.body': 'Die Quelle zählt die Dimensionen mit mittlerem und hohem Risiko und liest den ARL aus ihrer Nachschlagetabelle ab. Dieses Tool verwendet die Tabelle genau wie abgedruckt.',
  'arl.result.mark.start': 'Beginn',
  'arl.result.mark.target': 'Ziel',
  'arl.result.modify': 'Dieses Tool tut das nicht: Jedes Ergebnis verwendet die abgedruckte Tabelle, damit Ergebnisse vergleichbar bleiben.',
  ...
  'guide.fig.tier2.converter': 'Leistungswandler',
  ...
  'guide.fig.tier2.caption.after': '. Der Wert 4 des Harvesters hebt sie nicht an, und es wird nichts gemittelt.',
  ...
  'guide.fig.arlLookup.caption.after': '. Zwei weitere Einstufungen „Hoch“, und dasselbe Profil ergibt ARL 3: Hohe Risiken wiegen am schwersten.',
  'guide.fig.cte.label': 'Eine Wellenboje, aufgeteilt in fünf Elemente: Energy-Harvester, Leistungswandlung, Telemetrie-Firmware, Gehäuse und Abdichtung — alle kritisch — sowie das Verankerungs- und Bergungsverfahren, das ein Prozess ist und hier nicht kritisch.',
  'guide.fig.cte.system': 'Wellenboje (System)',
  'guide.fig.cte.harvester': 'Energy-\nHarvester',
  'guide.fig.cte.power': 'Leistungs-\nwandlung',
  'guide.fig.cte.firmware': 'Telemetrie-\nFirmware',
  'guide.fig.cte.enclosure': 'Gehäuse &\nAbdichtung',
  'guide.fig.cte.mooring': 'Verankerung\n& Bergung',
  'guide.fig.cte.critical': 'kritisch',
  'guide.fig.cte.notCritical': 'nicht kritisch',
  'guide.fig.cte.caption': 'Jedes Element wird für sich bewertet. Auch ein Prozess kann ein CTE sein; „kritisch“ entscheidet, was in die Systemzusammenfassung einfließt.',
  ...
  'guide.fig.env.label': 'Die Realitätsnähe der Umgebung steigt von reiner Analyse über das Labor und eine relevante Umgebung wie ein Meerwasserbecken bis zu einem begrenzten Einsatz in der Einsatzumgebung und schließlich dem vollen Missionsbereich. TRL 5 und 6 erfordern eine relevante Umgebung; TRL 7 und 8 die Einsatzumgebung.',
  'guide.fig.env.e0.name': 'Nur Analyse',
  'guide.fig.env.e0.note': 'Modelle, keine Hardware',
  'guide.fig.env.e1.name': 'Labor',
  'guide.fig.env.e1.note': 'Prüfstand, Luft, Raumtemperatur',
  'guide.fig.env.e2.name': 'Relevant',
  'guide.fig.env.e2.note': 'Meerwasserbecken, Bewegung, Kälte',
  'guide.fig.env.e3.name': 'Einsatzumgebung (begrenzt)',
  'guide.fig.env.e3.note': 'kurzer Einsatz, ruhige Jahreszeit',
  ...
  'guide.fig.env.caption': 'Ein Test im Süßwasserbecken ist keine relevante Umgebung für einen Ausfallmechanismus, der leitfähiges Meerwasser voraussetzt.',
  ...
  'guide.fig.frameworks.label': 'marine-energy-eere erweitert dod-tra-2025: Es übernimmt die DoD-Kriterien, ergänzt acht maritime Anpassungen und bezieht seine Tier-1-Fragen aus den EERE-Definitionen, TRL 9 aus der DoD-Tabelle.',
  ...
  'guide.fig.frameworks.marine': 'marine-energy-eere (Standard)',
  ...
  'guide.page.overview.summary': 'Was TRLs sind, woher die Skala 1–9 stammt und wo dieses Tool einzuordnen ist.',
  'guide.page.how-to-use.title': 'So verwenden Sie dieses Tool',
  'guide.page.how-to-use.summary': 'Schritt für Schritt durch beide Tiers, dazu Speichern, Fortsetzen und Löschen von Daten.',
  ...
  'guide.page.cte.summary': 'Wie Sie ein System in CTEs zerlegen, mit Beispielen und häufigen Fehlern.',
  ...
  'guide.page.excel.summary': 'Beide Arbeitsmappen Blatt für Blatt und wie die Platzhalter funktionieren.',
  'guide.page.frameworks.title': 'Frameworks & Quellen',
  'guide.page.frameworks.summary': 'Was jedes Framework enthält, woher es stammt und wo seine Grenzen liegen.',
  ...
  'guide.page.marine-and-ocean.title': 'Meeres- und Ozeananpassung',
  'guide.page.marine-and-ocean.summary': 'Was „relevante Umgebung“ auf See bedeutet, und verwandte Reifegradskalen.',
  'guide.page.stage-crosswalk.title': 'Phasen-Zuordnung',
  'guide.page.stage-crosswalk.summary': 'Ein Phasenmodell der Sensorentwicklung, dem TRL zugeordnet — nur zur Information.',
  'guide.page.faq.title': 'FAQ',
  'guide.page.faq.summary': 'Fünfzehn Fragen, die tatsächlich gestellt werden.',
  'guide.page.glossary.title': 'Glossar',
  'guide.page.glossary.summary': 'TRL, TRA, CTE, relevante Umgebung, TPL, MRL, IRL, SRL, ARL und mehr.',
