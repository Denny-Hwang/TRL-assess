...
export const guide = {
  ...
  'guide.fig.tier2.harvester': 'Harvester',
  'guide.fig.tier2.converter': 'Power converter',
  ...
  'guide.fig.tier2.caption.after':
    '. The harvester’s 4 does not pull it up, and nothing is averaged.',
  ...
  'guide.fig.arlLookup.caption.after':
    '. Two more High ratings and the same profile reads ARL 3: High risks weigh heaviest.',

  // CTE decomposition tree. "\n" marks where a box label wraps onto its second line.
  'guide.fig.cte.label':
    'A wave buoy split into five elements: energy harvester, power conversion, telemetry firmware, enclosure and sealing — all critical — and the mooring and recovery procedure, which is a process and not critical here.',
  'guide.fig.cte.system': 'Wave buoy (system)',
  'guide.fig.cte.harvester': 'Energy\nharvester',
  'guide.fig.cte.power': 'Power\nconversion',
  'guide.fig.cte.firmware': 'Telemetry\nfirmware',
  'guide.fig.cte.enclosure': 'Enclosure\n& sealing',
  'guide.fig.cte.mooring': 'Mooring &\nrecovery',
  'guide.fig.cte.critical': 'critical',
  'guide.fig.cte.notCritical': 'not critical',
  'guide.fig.cte.caption':
    'Each element is assessed on its own. A process can be a CTE; “critical” decides what counts towards the system summary.',
  ...
  'guide.fig.env.label':
    'Environment fidelity rises from analysis only, through laboratory, a relevant environment such as a seawater tank, to a limited operational deployment and finally the full mission range. TRL 5 and 6 need a relevant environment; TRL 7 and 8 need the operational one.',
  'guide.fig.env.e0.name': 'Analysis only',
  'guide.fig.env.e0.note': 'models, no hardware',
  'guide.fig.env.e1.name': 'Laboratory',
  'guide.fig.env.e1.note': 'bench, air, room temperature',
  'guide.fig.env.e2.name': 'Relevant',
  'guide.fig.env.e2.note': 'seawater tank, motion, cold',
  'guide.fig.env.e3.name': 'Operational (limited)',
  'guide.fig.env.e3.note': 'short deployment, calm season',
  ...
  'guide.fig.env.caption':
    'A fresh-water tank test is not a relevant environment for a failure mode that needs conductive seawater.',
  ...
  'guide.fig.frameworks.label':
    'marine-energy-eere extends dod-tra-2025: it reuses the DoD criteria, adds eight marine tailoring items, and takes its Tier 1 questions from the EERE definitions, with TRL 9 from the DoD table.',
  ...
  'guide.fig.frameworks.marine': 'marine-energy-eere (default)',
  ...
  'guide.page.overview.summary':
    'What TRLs are, where the 1–9 scale came from, and where this tool fits.',
  'guide.page.how-to-use.title': 'How to use this tool',
  'guide.page.how-to-use.summary':
    'Step by step through both tiers, plus saving, resuming and clearing data.',
  ...
  'guide.page.cte.summary':
    'How to decompose a system into CTEs, with examples and common mistakes.',
  ...
  'guide.page.excel.summary': 'Both workbooks sheet by sheet, and how the placeholders work.',
  'guide.page.frameworks.title': 'Frameworks & sources',
  'guide.page.frameworks.summary':
    'What each framework contains, where it comes from, and its limitations.',
  ...
  'guide.page.marine-and-ocean.title': 'Marine & ocean tailoring',
  'guide.page.marine-and-ocean.summary':
    'What "relevant environment" means at sea, and related readiness scales.',
  'guide.page.stage-crosswalk.title': 'Stage crosswalk',
  'guide.page.stage-crosswalk.summary':
    'A sensor development-stage model mapped to TRL — informational only.',
  'guide.page.faq.title': 'FAQ',
  'guide.page.faq.summary': 'Fifteen questions people actually ask.',
  'guide.page.glossary.title': 'Glossary',
  'guide.page.glossary.summary':
    'TRL, TRA, CTE, relevant environment, TPL, MRL, IRL, SRL, ARL and more.',
} as const;
